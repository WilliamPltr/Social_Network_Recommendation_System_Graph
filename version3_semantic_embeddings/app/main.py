"""
FastAPI application for the semantic-embedding snapshot.
"""
...
app = FastAPI(
    ...
    description="Snapshot with semantic job embeddings.",
    version="0.3.0",
)
...
async def recommend_jobs(
    ...
    """
    Job recommendations based on semantic embeddings.
    """
